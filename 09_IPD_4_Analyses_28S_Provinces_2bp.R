...
write.xlsx(alldata.df, col.names=TRUE, "E:/0_Master_Thesis/R_test/Final_R/28S_8Provinces/2bp/alldata.df.xlsx")
...
write.xlsx(REGS.OTU.FRQ.df, col.names=TRUE, "E:/0_Master_Thesis/R_test/Final_R/28S_8Provinces/2bp/REGS.OTU.FRQ.df_2bp.xlsx")
...
library(xlsx)
write.xlsx(tREGS.OTU.FRQ.df, col.names=TRUE, "E:/0_Master_Thesis/R_test/Final_R/28S_8Provinces/2bp/tREGS.OTU.FRQ.df_2bp.xlsx")
...
write.xlsx(REGS.SO.MAT, col.names=TRUE, "E:/0_Master_Thesis/R_test/Final_R/28S_8Provinces/2bp/REGS.SO.MAT.xlsx")
...
library(xlsx)
write.xlsx(REGS.JA.MAT, col.names=TRUE, "E:/0_Master_Thesis/R_test/Final_R/28S_8Provinces/2bp/REGS.JA.MAT.xlsx")
