...
write.xlsx(DistMatr_by_descrip, col.names=TRUE, "E:/0_Master_Thesis/R_test/Final_R/28S_8Provinces/4bp/DistMatr_by_descrip.xlsx")
...
print("continue with  05_IPD_4_Analyses_28S_8Provinces_4bp")
#### continue with  05_IPD_4_Analyses_28S_8Provinces_4bp
