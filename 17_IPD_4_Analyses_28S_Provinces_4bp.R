...
write.xlsx(alldata.df, col.names=TRUE, "E:/0_Master_Thesis/R_test/Final_R/28S_8Provinces/4bp/alldata.df.xlsx")
...
write.xlsx(REGS.OTU.FRQ.df, col.names=TRUE, "E:/0_Master_Thesis/R_test/Final_R/28S_8Provinces/4bp/REGS.OTU.FRQ.df.xlsx")
...
library(xlsx)
write.xlsx(tREGS.OTU.FRQ.df, col.names=TRUE, "E:/0_Master_Thesis/R_test/Final_R/28S_8Provinces/4bp/tREGS.OTU.FRQ.df_4bp.xlsx")
...
my_palette <- colorRampPalette(brewer.pal(7, "Purples"))(299)
...
write.xlsx(REGS.SO.MAT, col.names=TRUE, "E:/0_Master_Thesis/R_test/Final_R/28S_8Provinces/4bp/REGS.SO.MAT.xlsx")
...
library(xlsx)
write.xlsx(REGS.JA.MAT, col.names=TRUE, "E:/0_Master_Thesis/R_test/Final_R/28S_8Provinces/4bp/REGS.JA.MAT.xlsx")
