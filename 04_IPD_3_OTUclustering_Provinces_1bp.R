...
write.xlsx(DistMatr_by_descrip, col.names=TRUE, "E:/0_Master_Thesis/R_test/Final_R/28S_8Provinces/1bp/DistMatr_by_descrip.xlsx")
write.xlsx(alldata.df, col.names=TRUE, "E:/0_Master_Thesis/R_test/Final_R/28S_8Provinces/1bp/alldata.df.xlsx")
...
print("continue with  05_IPD_4_Analyses_28S_8Provinces_1bp")
#### continue with  05_IPD_4_Analyses_28S_8Provinces_1bp
