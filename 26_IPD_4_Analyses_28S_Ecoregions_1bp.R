...
write.xlsx(REGS.OTU.FRQ.df, col.names=TRUE, "E:/0_Master_Thesis/R_test/Final_R/Ecoregions/28S/1bp/REGS.OTU.FRQ.df_1bp.xlsx")
...
write.xlsx(tREGS.OTU.FRQ.df, col.names=TRUE, "E:/0_Master_Thesis/R_test/Final_R/Ecoregions/28S/1bp/tREGS.OTU.FRQ.df_1bp.xlsx")
...
library(xlsx)
write.xlsx(REGS.JA.MAT, col.names=TRUE, "E:/0_Master_Thesis/R_test/Final_R/Ecoregions/28S/1bp/REGS.JA.MAT.xlsx")
