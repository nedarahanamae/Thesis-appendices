...
write.xlsx(REGS.OTU.FRQ.df, col.names=TRUE, "E:/0_Master_Thesis/R_test/Final_R/Ecoregions/28S/3bp/REGS.OTU.FRQ.df_3bp.xlsx")
...
write.xlsx(tREGS.OTU.FRQ.df, col.names=TRUE, "E:/0_Master_Thesis/R_test/Final_R/Ecoregions/28S/3bp/tREGS.OTU.FRQ.df_3bp.xlsx")
...
write.xlsx(REGS.SO.MAT, col.names=TRUE, "E:/0_Master_Thesis/R_test/Final_R/Ecoregions/28S/3bp/REGS.SO.MAT.xlsx")
...
library(xlsx)
write.xlsx(REGS.JA.MAT, col.names=TRUE, "E:/0_Master_Thesis/R_test/Final_R/Ecoregions/28S/3bp/REGS.JA.MAT.xlsx")
