...
write.xlsx(REGS.OTU.FRQ.df, col.names=TRUE, "E:/0_Master_Thesis/R_test/Final_R/Ecoregions/28S/4bp/REGS.OTU.FRQ.df_4bp.xlsx")
...
write.xlsx(tREGS.OTU.FRQ.df, col.names=TRUE, "E:/0_Master_Thesis/R_test/Final_R/Ecoregions/28S/4bp/tREGS.OTU.FRQ.df_4bp.xlsx")
...
write.xlsx(REGS.SO.MAT, col.names=TRUE, "E:/0_Master_Thesis/R_test/Final_R/Ecoregions/28S/4bp/REGS.SO.MAT.xlsx")
...
library(xlsx)
write.xlsx(REGS.JA.MAT, col.names=TRUE, "E:/0_Master_Thesis/R_test/Final_R/Ecoregions/28S/4bp/REGS.JA.MAT.xlsx")
