...
write.xlsx(alldata.df, col.names=TRUE, "E:/0_Master_Thesis/R_test/Final_R/28S_8Provinces/3bp/alldata.df.xlsx")
...
write.xlsx(REGS.OTU.FRQ.df, col.names=TRUE, "E:/0_Master_Thesis/R_test/Final_R/28S_8Provinces/3bp/REGS.OTU.FRQ.df_3bp.xlsx")
...
library(xlsx)
write.xlsx(tREGS.OTU.FRQ.df, col.names=TRUE, "E:/0_Master_Thesis/R_test/Final_R/28S_8Provinces/3bp/tREGS.OTU.FRQ.df_3bp.xlsx")
...
my_palette <- colorRampPalette(brewer.pal(7, "Reds"))(299)
...
write.xlsx(REGS.SO.MAT, col.names=TRUE, "E:/0_Master_Thesis/R_test/Final_R/28S_8Provinces/3bp/REGS.SO.MAT.xlsx")
...
library(xlsx)
write.xlsx(REGS.JA.MAT, col.names=TRUE, "E:/0_Master_Thesis/R_test/Final_R/28S_8Provinces/3bp/REGS.JA.MAT.xlsx")
